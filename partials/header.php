<?php require 'partials/ip_user.php';?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
...
<body class="body" data-ip = "<?=$ipaddress;?>">
    <ul class="ul" data-id="<?= $base; ?>">
        <div class="link">
                ...
                <div class="option-apps">
                    <div class="option-itens">
                        ...
                        <div class="icons">
                            ...
                            <div class="item-text-icon">
                                <img src="<?= $base; ?>/assets/images/icons8-balão-de-fala-com-pontos-48.png"
                                    alt="perfil">
                                <p>Chat</p>
                            </div>
                        </div>
            ...
            <div class="auth-circle">
                <img id="userClick" src="<?= $base; ?>/assets/media/avatars/<?= $userInfo->getAvatar(); ?>"
                    alt="perfil">
