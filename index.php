        ...
        <div class="input-google-x">
          ...
          <div class="container-input">
            <div class="input-align">
              ...
              <input class="input-search icone" type="text" name="search"
                placeholder="Pesquise no Google ou pelo URL" />
            ...
            <div class="upload-image-group">
              <div class="title-image">
                ...
                <div class="icone-close-i">
                  <ion-icon style="cursor: pointer;" class="icone-close-image" name="close-outline">
                  </ion-icon>
                </div>
              </div>
                    ...
                    <div class="option-img">
                      ...
                      <div class="option-i">
                        <div class="i-atalho-text">
                          <a onclick="buttonUpdate(<?= $item->getId(); ?>)">
                            <p>Editar atalho</p>
                          </a>
                        </div>
                        <div class="i-atalho-text">
                          <a href="<?= $base; ?>/excluir_active.php?id=<?= $item->getId(); ?>">
                            <p>Remover</p>
                          </a>
                        </div>
                      </div>
